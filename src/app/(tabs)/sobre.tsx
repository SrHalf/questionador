...
Esta é uma aplicação simples que apresenta perguntas de verdadeiro ou falso, a partir de diversos arquivos JSON internos, e surgiu da necessidade de duas coisas:
- Aprender React Native.
- Criar uma solução para estudar e aprender leis diversas (e outros temas).

A ideia de aprender leis vem da minha intenção de **passar em um concurso público**. Ainda que eu seja incompetente para isso, espero poder aprender ambos os recursos ao mesmo tempo.
